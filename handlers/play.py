...
async def play(client: Client, message_: Message):
    ...
    res = await message_.reply_text("✯IWANSONG✯=🔄 Processing...")
    ...
    if message_.chat.id in tgcalls.pytgcalls.active_calls:
        ...
        await res.edit_text(f"✯IWANSONG✯=#️⃣ Queued at position {position}.")
    else:
        await res.edit_text("✯IWANSONG✯=▶️ Playing...")
        res.delete
        m = await client.send_photo(
        chat_id=message_.chat.id,
        photo="https://telegra.ph/file/290ff3ba1f470109e25ac.jpg",
        caption=f"Playing Your song Via  [✯IWANSONG✯](https://t.me/RI024).",
         ) 
...
async def jiosaavn(client: Client, message_: Message):
    ...
    m = await client.send_photo(
        chat_id=message_.chat.id,
        caption=f"Playing {sname} Via [JOIN KUY](https://t.me/RI024)",
        photo="final.png",
    )
    os.remove("final.png")
...
async def ytp(client: Client, message_: Message):
    ...
    m = await client.send_photo(
        chat_id=message_.chat.id,
        caption=f"Playing `{query}` Via [JOIN CHATKUY](https://t.me/RI024)",
        photo="final.png",
